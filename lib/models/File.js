...
const FileSchema = new mongoose.Schema({
  ...
  ipfsUrl: {
    type: String,
    required: false, // Full IPFS URL with gateway
  },
  gateway: {
    type: String,
    required: false, // IPFS gateway used
  },
  downloadId: {
    type: String,
    required: true,
  ...
  qrCode: {
    type: String,
    default: null, // Base64 data URL for QR code
  },
}, {
  timestamps: true,
});

// Index for efficient queries (downloadId index already created by unique: true)
